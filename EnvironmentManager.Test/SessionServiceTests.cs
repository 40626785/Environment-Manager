...
public class SessionServiceTests
{
    ...
    public async Task NewSession_Timeout_LogoutCalled()
    {
        ...
        SessionService sessionService = new SessionService(loginNavService.Object, mainThread.Object, localStorage.Object);
        var ttl = typeof(SessionService).GetField("_ttl", BindingFlags.NonPublic | BindingFlags.Instance);
        ttl.SetValue(sessionService, 5);
        //Action
        ...
        localStorage.Verify(x => x.SetStringValue("role","Administrator"), Times.Once);
    }
}